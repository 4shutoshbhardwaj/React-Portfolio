		...
		>
			<div className={styles.container}>
				...
				>
					...
					<a
						href='mailto:4shutoshbhardwaj@gmail.com'
						aria-label='email'
						target='_blank'
						rel='noreferrer'
					>
					...
					<a
						href='https://github.com/4shutoshbhardwaj'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/4shutoshbhardwaj7/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
			...
			>
				Designed and build by Ashutosh Bhardwaj
			</div>
		</footer>
	);
};
