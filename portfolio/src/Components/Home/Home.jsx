		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
						I am a Full Stack Developer based in Pune. I build
						things for web.
					</h1>
					<div className={styles.btn}>
						
						<a href='https://drive.google.com/drive/folders/1MwvPdYi33oKPcW8WqVSim8VDfej3h2Up?usp=share_link' target='_blank' rel='noopener noreferrer'>
							<Button
								text={
