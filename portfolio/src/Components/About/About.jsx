	...
	return (
		...
		>
			...
			<div className={styles.second}>
				...
				>
					Hello! My name is Ashutosh and I enjoy creating things that are live on the internet. My interest in web development started
					...
					applications and many major projects. Learned a great deal
